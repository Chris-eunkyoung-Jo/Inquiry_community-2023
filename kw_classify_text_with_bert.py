...
text_test = ['demarcation line should be 38 latitude']
...
examples = ['demarcation line should be 38 latitude', 'prisoners of war should be returned back according to their orientation']
'''
examples = [
